...
(NO HARDWARE REQUIRED), (NOT FOR BEGINNERS)
...
### Note : Some objects may not get detected as I am using a pre trained dataset, But if you want to enter custom data for your project your can following my [previous project](https://github.com/pranavvss/Hand-Face-detection-model-using-python) in that project i have show how you can enter your own data 
